...
function StatCard({
  ...
  const content = (
    <div className='h-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5 flex flex-col justify-between gap-1 hover:shadow-sm transition-shadow'>
      <div>
                ...
                <div key={r.id} className='px-4 py-3 flex items-center gap-3'>
                  <div className='flex-1 min-w-0'>
                    ...
                    <p className='text-xs text-zinc-400'>
                      ...
                      {formatDuration(r.startedAt, r.finishedAt ?? undefined)}
                    </p>
                  </div>
